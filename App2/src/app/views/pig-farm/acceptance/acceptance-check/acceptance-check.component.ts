...
import { AcceptanceCheck, Acceptance } from 'src/app/_core/_model/acceptances';
import { AcceptanceService, AcceptanceCheckService } from 'src/app/_core/_service/acceptances';
import { Subscription } from 'rxjs';
import { XAccountService } from 'src/app/_core/_service/xaccount.service';
@Component({
  selector: 'app-acceptance-check',
  templateUrl: './acceptance-check.component.html',
  styleUrls: ['./acceptance-check.component.scss']
})
export class AcceptanceCheckComponent extends BaseComponent implements OnInit, OnChanges {
  ...
  constructor(
    private service: AcceptanceCheckService,
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}AcceptanceCheck/LoadData?acceptanceGuid=${this.acceptance?.guid}&lang=${this.globalLang}`,
