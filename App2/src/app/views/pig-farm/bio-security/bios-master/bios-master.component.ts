...
@Component({
  selector: 'app-bios-master',
  templateUrl: './bios-master.component.html',
  styleUrls: ['./bios-master.component.scss']
})
export class BiosMasterComponent extends BaseComponent implements OnInit,OnChanges {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}BiosMaster/LoadData?farmGuid=${farmGuid}&lang=${this.globalLang}`,
