...
@Component({
  selector: 'app-system-menu-report-config',
  templateUrl: './system-menu-report-config.component.html',
  styleUrls: ['./system-menu-report-config.component.scss']
})
export class SystemMenuReportConfigComponent extends BaseComponent implements OnInit, OnChanges {
...
loadLang() {
  this.translate.get('System Menu Report').subscribe( functionName => {
...
toolbarClick(args) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}SysMenu/LoadReportMenuData?reportType=List`,
