...
import { RepairDetail, Repair } from 'src/app/_core/_model/repairs';
import { RepairService, RepairDetailService } from 'src/app/_core/_service/repairs';
...
export class RepairDetailComponent extends BaseComponent implements OnInit, OnChanges {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RepairDetail/LoadData?repairGuid=${this.repair?.guid}`,
