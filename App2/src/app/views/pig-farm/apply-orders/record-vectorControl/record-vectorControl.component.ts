...
import {
  RecordVectorControlService ,Record2PigService,
...
@Component({
  selector: 'app-record-vectorControl',
  templateUrl: './record-vectorControl.component.html',
  styleUrls: ['./record-vectorControl.component.css']
})
export class RecordVectorControlComponent
...
private router: Router,
  ...
  onParamChange() {
    ...
    if (data?.id > 0) {
      this.model = { ...data };
      this.areaGuid = this.model.areaGuid;
      this.barnGuid = this.model.barnGuid;
