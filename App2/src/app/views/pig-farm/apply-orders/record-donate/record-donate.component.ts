...
import {
  RecordDonateService ,Record2PigService,
...
@Component({
  selector: 'app-record-donate',
  templateUrl: './record-donate.component.html',
  styleUrls: ['./record-donate.component.css']
})
export class RecordDonateComponent
...
private router: Router,
  ...
  onChangeRoom(e) {
    ...
    let predicate: Predicate = new Predicate("type", "equal", "Record_Donate");
  ...
  // life cycle ejs-grid
    ...
    loadConfig() {
      let query = new Query();
      query.where("type", "equal", "Record_Donate");
