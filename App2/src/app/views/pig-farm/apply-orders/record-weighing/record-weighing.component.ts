...
import {
  RecordWeighingService ,Record2PigService,
...
@Component({
  selector: 'app-record-weighing',
  templateUrl: './record-weighing.component.html',
  styleUrls: ['./record-weighing.component.css']
})
export class RecordWeighingComponent
