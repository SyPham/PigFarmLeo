...
import {
  RecordImmunizationService ,Record2PigService,
...
@Component({
  ...
  styleUrls: ['./record-immunization.component.css']
})
export class RecordImmunizationComponent
...
private router: Router,
  ...
  loadButtonConfig() {
    ...
    let predicate: Predicate = new Predicate("type", "equal", "Record_Immunization");
  ...
  loadConfig() {
    let query = new Query();
    query.where("type", "equal", "Record_Immunization");
