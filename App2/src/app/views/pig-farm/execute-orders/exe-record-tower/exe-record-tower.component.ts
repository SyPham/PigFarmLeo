...
import { RecordTowerService } from "src/app/_core/_service/apply-orders";
declare let window: any;
@Component({
  selector: 'app-exe-record-tower',
  templateUrl: './exe-record-tower.component.html',
  styleUrls: ['./exe-record-tower.component.css']
})
export class ExeRecordTowerComponent
