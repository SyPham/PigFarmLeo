...
import { RecordInOutService } from "src/app/_core/_service/apply-orders";
declare let window: any;
@Component({
  selector: 'app-exe-record-inOut',
  templateUrl: './exe-record-inOut.component.html',
  styleUrls: ['./exe-record-inOut.component.css']
})
export class ExeRecordInOutComponent
