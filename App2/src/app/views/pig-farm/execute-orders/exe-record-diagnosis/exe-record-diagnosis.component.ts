...
import {
  Record2PigService,
  RecordDiagnosisService,
} from "src/app/_core/_service/apply-orders";
import { RecordDiagnosis } from "src/app/_core/_model/apply-orders";
import { PenService, RoomService } from "src/app/_core/_service/farms";
import { NgxSpinnerService } from "ngx-spinner";
declare let window: any;
@Component({
  selector: 'app-exe-record-diagnosis',
  templateUrl: './exe-record-diagnosis.component.html',
  styleUrls: ['./exe-record-diagnosis.component.css']
})
export class ExeRecordDiagnosisComponent
    ...
    create() {
      this.alertify.confirm4(
        ...
        () => {
          ...
          this.model.veterinaryDate = this.convertDateTime(this.model.veterinaryDate);
          this.model.inventoryDate = this.convertDateTime(this.model.inventoryDate);
