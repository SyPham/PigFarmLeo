...
export class DeathComponent extends BaseComponent implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    ...
    L10n.load(load);
    this.service.changeRecordDeath({});
 ...
 valueChange(value) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordDeath/LoadData?farmGuid=${farmGuid}&makeOrderGuid=${this.makeOrderGuid}&lang=${this.globalLang}`,
