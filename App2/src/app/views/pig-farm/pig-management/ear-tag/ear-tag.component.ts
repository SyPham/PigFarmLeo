...
export class EarTagComponent extends BaseComponent implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    ...
    L10n.load(load);
    this.service.changeRecordEarTag({});
 ...
 valueChange(value) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordEarTag/LoadData?farmGuid=${farmGuid}&makeOrderGuid=${this.makeOrderGuid}&lang=${this.globalLang}`,
