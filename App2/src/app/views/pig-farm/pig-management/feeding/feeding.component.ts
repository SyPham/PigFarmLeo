...
export class RecordFeedingComponent extends BaseComponent implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    ...
    L10n.load(load);
    this.service.changeRecordFeeding({});
...
penValueChange(value) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordFeeding/LoadData?farmGuid=${farmGuid}&makeOrderGuid=${this.makeOrderGuid}&lang=${this.globalLang}`,
