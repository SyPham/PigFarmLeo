...
@Component({
  selector: 'app-suckling',
  templateUrl: './suckling.component.html',
  styleUrls: ['./suckling.component.scss']
})
export class SucklingComponent implements OnInit {
