...
@Component({
  selector: 'app-new-boar',
  templateUrl: './new-boar.component.html',
  styleUrls: ['./new-boar.component.scss']
})
export class NewBoarComponent implements OnInit {
