...
export class RecordMoveComponent extends BaseComponent implements OnInit,OnDestroy {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordMove/LoadData?farmGuid=${farmGuid}&makeOrderGuid=${this.makeOrderGuid}&lang=${this.globalLang}`,
