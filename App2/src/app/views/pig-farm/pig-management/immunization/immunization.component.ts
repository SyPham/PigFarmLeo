...
@Component({
  selector: 'app-immunization2',
  templateUrl: './immunization.component.html',
  styleUrls: ['./immunization.component.scss']
})
export class ImmunizationComponent extends BaseComponent implements OnInit,OnDestroy, IBatchWorkCommon {
  ...
  ngOnInit() {
    ...
    L10n.load(load);
    this.service.changeRecordImmunization({});
...
penValueChange(value) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordImmunization/LoadData?farmGuid=${farmGuid}&makeOrderGuid=${this.makeOrderGuid}&lang=${this.globalLang}`,
