...
@Component({
  selector: 'app-record-disinfection',
  templateUrl: './record-disinfection.component.html',
  styleUrls: ['./record-disinfection.component.scss']
})
export class RecordDisinfectionComponent extends BaseComponent implements OnInit, OnChanges, IBatchWorkCommon {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}PigHouseDisinfection/BatchWorkLoadData?farmGuid=${farmGuid}&lang=${this.globalLang}&${query}`,
