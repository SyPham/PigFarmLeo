...
@Component({
  ...
  styleUrls: ['./record-weighing.component.scss']
})
export class RecordWeighingComponent extends BaseComponent implements OnInit, OnDestroy, IBatchWorkCommon {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordWeighing/BatchWorkLoadData?farmGuid=${farmGuid}&lang=${this.globalLang}&${query}`,
