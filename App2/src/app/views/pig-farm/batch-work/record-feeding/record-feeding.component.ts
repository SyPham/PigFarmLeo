...
import { MakeOrderService, RecordFeedingService } from 'src/app/_core/_service/records';
import { RecordFeeding } from 'src/app/_core/_model/records';
...
@Component({
  ...
  styleUrls: ['./record-feeding.component.scss']
})
export class RecordFeedingComponent extends BaseComponent implements OnInit,OnDestroy, IBatchWorkCommon {
...
penValueChange(value) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordFeeding/BatchWorkLoadData?farmGuid=${farmGuid}&lang=${this.globalLang}&${query}`,
