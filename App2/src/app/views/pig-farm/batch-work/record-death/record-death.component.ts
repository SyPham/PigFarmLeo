...
import { MakeOrderService, RecordDeathService } from 'src/app/_core/_service/records';
import { RecordDeath } from 'src/app/_core/_model/records';
...
@Component({
  ...
  styleUrls: ['./record-death.component.scss']
})
export class RecordDeathComponent extends BaseComponent implements OnInit,OnDestroy, IBatchWorkCommon{
 ...
 valueChange(value) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordDeath/BatchWorkLoadData?farmGuid=${farmGuid}&lang=${this.globalLang}&${query}`,
