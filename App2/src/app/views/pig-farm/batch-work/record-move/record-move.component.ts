...
import { MakeOrderService, RecordMoveService } from 'src/app/_core/_service/records';
import { RecordMove } from 'src/app/_core/_model/records';
...
@Component({
  ...
  styleUrls: ['./record-move.component.scss']
})
export class RecordMoveComponent extends BaseComponent implements OnInit,OnDestroy, IBatchWorkCommon {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordMove/BatchWorkLoadData?farmGuid=${farmGuid}&lang=${this.globalLang}&${query}`,
