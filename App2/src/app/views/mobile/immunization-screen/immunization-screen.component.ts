...
export class ImmunizationScreenComponent extends BaseComponent implements OnInit,OnDestroy, IBatchWorkCommon {
...
penValueChange(value) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordImmunization/LoadMobileData?farmGuid=${farmGuid}&lang=${this.globalLang}&${query}`,
