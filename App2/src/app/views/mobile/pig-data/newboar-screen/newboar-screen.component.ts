...
@Component({
  selector: 'app-newboar-screen',
  templateUrl: './newboar-screen.component.html',
  styleUrls: ['./newboar-screen.component.scss']
})
export class NewboarScreenComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    const type = this.translate.instant('New Boar');
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}MakeOrder/LoadMobileDataByType?farmGuid=${farmGuid}&pigType=New Boar`,
