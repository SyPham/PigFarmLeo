...
@Component({
  selector: 'app-finisher-screen',
  templateUrl: './finisher-screen.component.html',
  styleUrls: ['./finisher-screen.component.scss']
})
export class FinisherScreenComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    const type = this.translate.instant('Finisher');
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}MakeOrder/LoadMobileDataByType?farmGuid=${farmGuid}&pigType=Finisher`,
