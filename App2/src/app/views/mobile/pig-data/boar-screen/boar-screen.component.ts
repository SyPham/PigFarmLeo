...
@Component({
  selector: 'app-boar-screen',
  templateUrl: './boar-screen.component.html',
  styleUrls: ['./boar-screen.component.scss']
})
export class BoarScreenComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    const type = this.translate.instant('Boar');
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}MakeOrder/LoadMobileDataByType?farmGuid=${farmGuid}&pigType=Boar`,
