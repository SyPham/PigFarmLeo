...
@Component({
  selector: 'app-grower-screen',
  templateUrl: './grower-screen.component.html',
  styleUrls: ['./grower-screen.component.scss']
})
export class GrowerScreenComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    const type = this.translate.instant('Grower');
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}MakeOrder/LoadMobileDataByType?farmGuid=${farmGuid}&pigType=Grower`,
