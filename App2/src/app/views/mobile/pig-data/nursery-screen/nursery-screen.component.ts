...
@Component({
  selector: "app-nursery-screen",
  templateUrl: "./nursery-screen.component.html",
  styleUrls: ["./nursery-screen.component.scss"],
})
export class NurseryScreenComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    const type = this.translate.instant('Nusery');
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}MakeOrder/LoadMobileDataByType?farmGuid=${farmGuid}&pigType=Nursery`,
