...
@Component({
  selector: 'app-sow-screen',
  templateUrl: './sow-screen.component.html',
  styleUrls: ['./sow-screen.component.scss']
})
export class SowScreenComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    const type = this.translate.instant('Sow');
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}MakeOrder/LoadMobileDataByType?farmGuid=${farmGuid}&pigType=Sow`,
