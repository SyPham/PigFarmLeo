...
@Component({
  selector: 'app-suckling-screen',
  templateUrl: './suckling-screen.component.html',
  styleUrls: ['./suckling-screen.component.scss']
})
export class SucklingScreenComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    const type = this.translate.instant('Suckling');
    this.toolbarOptions = [type,'Search'];
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}MakeOrder/LoadMobileDataByType?farmGuid=${farmGuid}&pigType=Suckling`,
