...
@Component({
  selector: 'app-culling-screen',
  templateUrl: './culling-screen.component.html',
  styleUrls: ['./culling-screen.component.scss']
})
export class CullingScreenComponent extends BaseComponent implements OnInit,OnDestroy, IBatchWorkCommon {
 ...
 valueChange(value) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordCulling/LoadMobileData?farmGuid=${farmGuid}&lang=${this.globalLang}&${query}`,
