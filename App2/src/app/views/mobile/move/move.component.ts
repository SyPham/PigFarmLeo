...
import { RecordMoveService } from 'src/app/_core/_service/records';
...
export class MoveComponent extends BaseComponent  implements OnInit  {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordMove/LoadMobileData?farmGuid=${farmGuid}&lang=${this.globalLang}&${query}`,
