...
export class DeathScreenComponent extends BaseComponent implements OnInit,OnDestroy, IBatchWorkCommon {
 ...
 valueChange(value) {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}RecordDeath/LoadMobileData?farmGuid=${farmGuid}&lang=${this.globalLang}&${query}`,
