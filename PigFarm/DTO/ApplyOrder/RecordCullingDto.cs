...
{
    public partial class RecordCullingDto
    {
        ...
        public decimal? CullingMethod { get; set; }
        public decimal? CullingWeight { get; set; }
        public string CullingReason { get; set; }
...
public string CullingMethodName { get; set; }
public string CullingReasonName { get; set; }
