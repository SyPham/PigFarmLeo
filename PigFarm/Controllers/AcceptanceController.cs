...
namespace PigFarm.Controllers
{
    ...
    {
        private readonly IAcceptanceService _service;

        public AcceptanceController(IAcceptanceService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] AcceptanceDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] AcceptanceDto model)
        {
