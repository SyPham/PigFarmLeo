...
{
    public class RecordDeathController : ApiControllerBase
    {
        private readonly IRecordDeathService _service;

        public RecordDeathController(IRecordDeathService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordDeathDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordDeathDto model)
        {
