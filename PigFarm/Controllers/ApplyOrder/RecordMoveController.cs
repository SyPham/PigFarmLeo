...
{
    public class RecordMoveController : ApiControllerBase
    {
        private readonly IRecordMoveService _service;

        public RecordMoveController(IRecordMoveService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordMoveDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordMoveDto model)
        {
