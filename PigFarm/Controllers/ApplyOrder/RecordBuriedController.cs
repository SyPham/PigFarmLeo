...
{
    public class RecordBuriedController : ApiControllerBase
    {
        private readonly IRecordBuriedService _service;

        public RecordBuriedController(IRecordBuriedService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordBuriedDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordBuriedDto model)
        {
