...
{
    public class RecordRepairController : ApiControllerBase
    {
        private readonly IRecordRepairService _service;

        public RecordRepairController(IRecordRepairService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordRepairDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordRepairDto model)
        {
