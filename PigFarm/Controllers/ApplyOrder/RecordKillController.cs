...
{
    public class RecordKillController : ApiControllerBase
    {
        private readonly IRecordKillService _service;

        public RecordKillController(IRecordKillService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordKillDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordKillDto model)
        {
