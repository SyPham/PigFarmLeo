...
{
    public class RecordWeighingController : ApiControllerBase
    {
        private readonly IRecordWeighingService _service;

        public RecordWeighingController(IRecordWeighingService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordWeighingDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordWeighingDto model)
        {
