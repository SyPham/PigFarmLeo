...
{
    public class RecordGeneralController : ApiControllerBase
    {
        private readonly IRecordGeneralService _service;

        public RecordGeneralController(IRecordGeneralService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordGeneralDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordGeneralDto model)
        {
