...
{
    public class RecordChemicalController : ApiControllerBase
    {
        private readonly IRecordChemicalService _service;

        public RecordChemicalController(IRecordChemicalService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordChemicalDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordChemicalDto model)
        {
