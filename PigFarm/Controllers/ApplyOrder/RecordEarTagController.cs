...
{
    public class RecordEarTagController : ApiControllerBase
    {
        private readonly IRecordEarTagService _service;

        public RecordEarTagController(IRecordEarTagService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordEarTagDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordEarTagDto model)
        {
