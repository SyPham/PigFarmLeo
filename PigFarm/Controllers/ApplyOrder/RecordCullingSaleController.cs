...
{
    public class RecordCullingSaleController : ApiControllerBase
    {
        private readonly IRecordCullingSaleService _service;

        public RecordCullingSaleController(IRecordCullingSaleService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordCullingSaleDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordCullingSaleDto model)
        {
