...
{
    public class RecordStolenController : ApiControllerBase
    {
        private readonly IRecordStolenService _service;

        public RecordStolenController(IRecordStolenService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordStolenDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordStolenDto model)
        {
