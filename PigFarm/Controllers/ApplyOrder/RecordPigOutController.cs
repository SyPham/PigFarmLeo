...
{
    public class RecordPigOutController : ApiControllerBase
    {
        private readonly IRecordPigOutService _service;

        public RecordPigOutController(IRecordPigOutService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordPigOutDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordPigOutDto model)
        {
