...
{
    public class RecordSaleController : ApiControllerBase
    {
        private readonly IRecordSaleService _service;

        public RecordSaleController(IRecordSaleService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordSaleDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordSaleDto model)
        {
