...
{
    public class RecordInOutController : ApiControllerBase
    {
        private readonly IRecordInOutService _service;

        public RecordInOutController(IRecordInOutService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordInOutDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordInOutDto model)
        {
