...
{
    public class RecordInventoryCheckController : ApiControllerBase
    {
        private readonly IRecordInventoryCheckService _service;

        public RecordInventoryCheckController(IRecordInventoryCheckService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordInventoryCheckDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordInventoryCheckDto model)
        {
