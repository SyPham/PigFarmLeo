...
{
    public class RecordDonateController : ApiControllerBase
    {
        private readonly IRecordDonateService _service;

        public RecordDonateController(IRecordDonateService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordDonateDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordDonateDto model)
        {
