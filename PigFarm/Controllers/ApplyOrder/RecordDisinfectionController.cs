...
{
    public class RecordDisinfectionController : ApiControllerBase
    {
        private readonly IRecordDisinfectionService _service;

        public RecordDisinfectionController(IRecordDisinfectionService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordDisinfectionDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordDisinfectionDto model)
        {
