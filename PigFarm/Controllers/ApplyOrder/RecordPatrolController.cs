...
{
    public class RecordPatrolController : ApiControllerBase
    {
        private readonly IRecordPatrolService _service;

        public RecordPatrolController(IRecordPatrolService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordPatrolDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordPatrolDto model)
        {
