...
{
    public class RecordVectorControlController : ApiControllerBase
    {
        private readonly IRecordVectorControlService _service;

        public RecordVectorControlController(IRecordVectorControlService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordVectorControlDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordVectorControlDto model)
        {
