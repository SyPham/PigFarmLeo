...
{
    public class RecordPigInController : ApiControllerBase
    {
        private readonly IRecordPigInService _service;

        public RecordPigInController(IRecordPigInService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RecordPigInDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RecordPigInDto model)
        {
