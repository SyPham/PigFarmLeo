...
{
    public class ThingController : ApiControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult> GetThings(string farmGuid)
        {
            return Ok(await _service.GetThings(farmGuid));
        }
        [HttpGet]
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] ThingDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] ThingDto model)
        {
