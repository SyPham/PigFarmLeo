...
namespace PigFarm.Controllers
{
    public class RequisitionController : ApiControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RequisitionDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RequisitionDto model)
        {
        ...
        [HttpGet]
        public async Task<ActionResult> GetRequisitions(string farmGuid)
        {
            return Ok(await _service.GetRequisitions(farmGuid));
        }
        [HttpGet]
