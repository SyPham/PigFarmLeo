...
{
    public class VectorControlController : ApiControllerBase
    {
        private readonly IVectorControlService _service;

        public VectorControlController(IVectorControlService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] VectorControlDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] VectorControlDto model)
        {
        ...
        [HttpGet]
        public async Task<ActionResult> GetVectorControls()
        {
            ...
            return Ok(await _service.GetVectorControls(farmGuid, top, skip, search, selected));
        }
        [HttpGet]
