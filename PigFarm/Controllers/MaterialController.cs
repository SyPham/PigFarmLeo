...
namespace PigFarm.Controllers
{
    public class MaterialController : ApiControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult> GetMaterials(string farmGuid)
        {
            return Ok(await _service.GetMaterials(farmGuid));
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] MaterialDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] MaterialDto model)
        {
        ...
        [HttpGet]
        public async Task<ActionResult> GetMaterials2()
        {
            ...
            return Ok(await _service.GetMaterials(farmGuid, top, skip, search, selected));
        }
        [HttpGet]
