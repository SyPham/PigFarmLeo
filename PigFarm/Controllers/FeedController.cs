...
namespace PigFarm.Controllers
{
    public class FeedController : ApiControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] FeedDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] FeedDto model)
        {
        ...
        [HttpGet]
        public async Task<ActionResult> GetFeeds()
        {
            ...
            return Ok(await _service.GetFeeds(farmGuid, top, skip, search, selected));
        }
        [HttpPost]
