...
namespace PigFarm.Controllers
{
    public class RfidController : ApiControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult> GetRfids(string farmGuid)
        {
            return Ok(await _service.GetRfids(farmGuid));
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] RfidDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] RfidDto model)
        {
        ...
        [HttpGet]
        public async Task<ActionResult> GetRfids2()
        {
            ...
            return Ok(await _service.GetRfids(farmGuid, top, skip, search, selected));
        }
        [HttpGet]
