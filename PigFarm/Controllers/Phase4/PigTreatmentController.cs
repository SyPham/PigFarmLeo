...
{
    public class PigTreatmentController : ApiControllerBase
    {
        private readonly IPigTreatmentService _service;

        public PigTreatmentController(IPigTreatmentService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] PigTreatmentDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] PigTreatmentDto model)
        {
        ...
        [HttpGet]
        public async Task<ActionResult> ToggleEstDate(int id)
        {
