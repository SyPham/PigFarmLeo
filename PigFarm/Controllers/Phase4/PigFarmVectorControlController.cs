...
{
    public class PigFarmVectorControlController : ApiControllerBase
    {
        private readonly IPigFarmVectorControlService _service;

        public PigFarmVectorControlController(IPigFarmVectorControlService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] PigFarmVectorControlDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] PigFarmVectorControlDto model)
        {
