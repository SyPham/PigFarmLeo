...
{
    public class BomTreatmentController : ApiControllerBase
    {
        private readonly IBomTreatmentService _service;

        public BomTreatmentController(IBomTreatmentService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] BomTreatmentDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] BomTreatmentDto model)
        {
